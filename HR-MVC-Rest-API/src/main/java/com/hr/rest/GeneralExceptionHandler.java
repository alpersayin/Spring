...
import com.hr.rest.APIErrorResponse;
...
public class GeneralExceptionHandler {
	...
	@ExceptionHandler // Controller seviyesinde bir exception handler,bu controllerda bir exception gerçekleşirse nolursa olsun burası çalışacak
	public ResponseEntity<APIErrorResponse> handleException(NumberFormatException exc) { // eğer buraya DepartmentNotFoundException exc yazarsak sadece not foundda çalışcak Exception exc yazarsak tüm hatalar için yapıcak.
		
		APIErrorResponse errorResponse = new APIErrorResponse();
		errorResponse.setMessage("sayı giriniz...");
